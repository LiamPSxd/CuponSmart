...
INSERT INTO promocion(nombre, descripcion, imagen, fechaInicio, fechaTermino, restricciones, numeroCupones, codigo, valor, idEstatus, idCategoria, idEmpresa, idTipoPromocion) VALUES ("Membresía Anual con Descuento", "Obtén un 30% de descuento en la membresía anual", "", "202-12-01", "2024-12-31", "Aplica para nuevos socios", 20, "FITNESS3", "30", 1, 5, 7, 1);
INSERT INTO promocion(nombre, descripcion, imagen, fechaInicio, fechaTermino, restricciones, numeroCupones, codigo, valor, idEstatus, idCategoria, idEmpresa, idTipoPromocion) VALUES ("Compra 2, Paga menos", "Lleva 2 libros y te descontamos $100", "", "2023-12-03", "2023-12-15", "Aplica en todos los géneros", 15, "LIBRO3X2", "100", 1, 6, 8, 2);
INSERT INTO promocion(nombre, descripcion, imagen, fechaInicio, fechaTermino, restricciones, numeroCupones, codigo, valor, idEstatus, idCategoria, idEmpresa, idTipoPromocion) VALUES ("Descuento en Medicamentos", "Obtén un 15% de descuento en todos los medicamentos", "", "2023-12-05", "2023-12-10", "Válido con receta médica", 10, "SALUD150", "15", 1, 7, 9, 1);
INSERT INTO promocion(nombre, descripcion, imagen, fechaInicio, fechaTermino, restricciones, numeroCupones, codigo, valor, idEstatus, idCategoria, idEmpresa, idTipoPromocion) VALUES ("Electrónicos a Precios Bajos", "Descuentos del 10% en toda la línea de productos", "", "2023-12-07", "2024-12-14", "No aplica en productos ya rebajados", 15, "TECHSALE", "25", 1, 8, 10, 1);
INSERT INTO promocion(nombre, descripcion, imagen, fechaInicio, fechaTermino, restricciones, numeroCupones, codigo, valor, idEstatus, idCategoria, idEmpresa, idTipoPromocion) VALUES ("Flores de Temporada", "Compra un ramo de flores de temporada y recibe un descuento de $30", "", "2023-12-02", "2024-12-10", "Válido solo para flores de temporada", 10, "FLORES10", "30", 1, 12, 11, 2);
