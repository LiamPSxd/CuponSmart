...
public class SucursalDAO{
    ...
    public static RespuestaSucursal obtenerSucursalesPorIdEmpresa(Integer idEmpresa){
        RespuestaSucursal respuesta = new RespuestaSucursal();
        ...
        if(conexionBD != null){
            try{
                List<Sucursal> sucursales = conexionBD.selectList("sucursales.obtenerSucursalesPorIdEmpresa", idEmpresa);
