...
public class CiudadDAO{
    ...
    public static RespuestaCiudad obtenerCiudadesPorIdMunicipio(Integer idMunicipio){
        RespuestaCiudad respuesta = new RespuestaCiudad();
        ...
        if(conexionBD != null){
            try{
                List<Ciudad> ciudades = conexionBD.selectList("ciudades.obtenerCiudadesPorIdMunicipio", idMunicipio);
